...
private:
    ...
    QRectF _rectWithoutMargins(const QRectF& rect, CONTENT_TYPE content_type);
...
void CanvasTree::CanvasNode::_constrainIntoRect(const QRectF& rect)
{
    ...
    else if (isTerminal())
    {
        ...
        // TODO decompose in multiple functions
        // TODO add const to non-modified variables
        QRectF rectWithoutMargins =
