...
QRectF LayoutPolicy::_getAvailableSpace() const{
    qreal left_width_margin =_group.width() * INSIDE_MARGIN_RELATIVE +
    ...
    return QRectF(left_width_margin, top_margin, _group.width() - left_width_margin - right_width_margin,
